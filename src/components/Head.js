  ...
  return (
    <div className='grid grid-flow-col p-2 m-2 shadow-lg'>
      <div className='flex col-span-1 items-center gap-2'>
        ...
        <span className='h-6'>
            <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt13" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true" style={{ pointerEvents: 'none', display: 'inherit', width: '100%', height: '100%' }}>
                <g>
